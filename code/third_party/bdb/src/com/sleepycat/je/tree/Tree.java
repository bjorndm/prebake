 ...
 *
 * $Id: Tree.java,v 1.488 2010/01/04 15:50:50 cwl Exp $
 */
    ...
    public SearchResult getParentINForChildIN(long targetNodeId,
        ...
        if (rootIN != null) {
            ...
            try {
                ...
                /*
                 * Should never happen because we use exclusive latches when
                 * doFetch is true, and of course we do not fetch (which throws
                 * RelatchRequiredException) when doFetch is false.
                 */
