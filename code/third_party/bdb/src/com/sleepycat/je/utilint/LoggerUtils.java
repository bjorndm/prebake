 ...
 *
 * $Id: LoggerUtils.java,v 1.11 2010/01/04 15:50:52 cwl Exp $
 */
...
public class LoggerUtils {
    ...
    public static Logger getLogger(Class<?> cl) {
        ...
        for (Handler h : logger.getHandlers()) {
            ...
            /*
             * Intentionally check for java.util.logging.ConsoleHandler rather
             * than ConsoleRedirectHandler, because the loggers that do not
             * have a custom prefix use the ConsoleHandler directly. Having
             * ConsoleRedirectHandler extend ConsoleHandler lets us have a
             * model where the user only have to set
             * com.sleepycat.je.util.ConsoleHandler in their logging properties
             * file.
             */
    ...
    public static Logger getLoggerFixedPrefix(Class<?> cl,
        ...
        boolean hasConsoleHandler = false;
        for (Handler h : logger.getHandlers()) {
            if (h instanceof com.sleepycat.je.util.ConsoleHandler) {
                hasConsoleHandler = true;
            }
        }
