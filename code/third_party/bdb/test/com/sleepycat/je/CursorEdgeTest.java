 ...
 *
 * $Id: CursorEdgeTest.java,v 1.54 2010/01/04 15:50:58 cwl Exp $
 */
...
public class CursorEdgeTest extends DualTestCase {
    ...
    private void checkForCursorUpdateException(boolean isSecUpdateError,
        ...
        if (isSecUpdateError) {
            assertTrue(msg,
                       msg.startsWith("Operation not allowed on a secondary"));
        } else {
            assertTrue(msg, msg.startsWith("A transaction was not supplied"));
        }
    }
