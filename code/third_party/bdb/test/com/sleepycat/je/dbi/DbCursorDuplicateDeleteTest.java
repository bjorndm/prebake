 ...
 *
 * $Id: DbCursorDuplicateDeleteTest.java,v 1.70 2010/01/04 15:51:00 cwl Exp $
 */
...
public class DbCursorDuplicateDeleteTest extends DbCursorTestBase {
    ...
    public void testEmptyNodes()
        ...
        synchronized (DbInternal.getEnvironmentImpl(exampleEnv).
            ...
            BIN bin = null;
            try {
                bin = (BIN) DbInternal.getDatabaseImpl(exampleDb).
                    getTree().
                ...
                bin = null;
                dupRoot.latch();
                bin = DbInternal.getDatabaseImpl(exampleDb).
                    getTree().
