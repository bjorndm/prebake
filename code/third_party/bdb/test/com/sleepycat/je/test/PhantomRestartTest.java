 ...
 *
 * $Id: PhantomRestartTest.java,v 1.20 2010/01/04 15:51:07 cwl Exp $
 */
...
public class PhantomRestartTest extends DualTestCase {
    ...
    protected static Class<?> testClass = PhantomRestartTest.class;
    ...
    public static Test suite()
        ...
        Constructor constructor = testClass.getConstructor(
                new Class[]{Spec.class, java.lang.Boolean.class});

        for (int i = 0; i < SPECS.length; i += 1) {
            for (int j = 0; j < 2; j += 1) {
                boolean dups = (j != 0);
                suite.addTest(
                       (DualTestCase) constructor.newInstance(SPECS[i], dups));
            }
        }
        return suite;
    }
