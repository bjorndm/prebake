 ...
 *
 * $Id: BinDeltaTest.java,v 1.59 2010/01/04 15:51:07 cwl Exp $
 */
...
public class BinDeltaTest extends TestCase {
    ...
    private void logAndCheck(BIN targetBIN)
         ...
         */
        assertEquals(DbLsn.NULL_LSN,
                     targetBIN.log(logManager, true, false, false, null));
        ...
        BIN createdBIN =
            delta.reconstituteBIN(DbInternal.getEnvironmentImpl(env));
        if (DEBUG) {
