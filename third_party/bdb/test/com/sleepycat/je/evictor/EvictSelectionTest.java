 ...
 *
 * $Id: EvictSelectionTest.java,v 1.31 2010/01/04 15:51:01 cwl Exp $
 */
...
public class EvictSelectionTest extends TestCase {
    ...
    public void testEvictPass()
        ...
        StatGroup placeholder = new StatGroup("placeholder", "");
        stats.setMBAndEvictorStats(placeholder,
                                   evictor.loadStats(statsConfig));
