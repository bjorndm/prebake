 ...
 *
 * $Id: MakeLogEntryVersionData.java,v 1.27 2010/01/04 15:51:03 cwl Exp $
 */
...
public class MakeLogEntryVersionData {
    ...
    public static void main(String[] args)
        ...
        entry = new SingleItemEntry(LogEntryType.LOG_ROLLBACK_END,
                                    new RollbackEnd(DbLsn.NULL_LSN, 
                                                    DbLsn.NULL_LSN));
        envImpl.getLogManager().log(entry, ReplicationContext.NO_REPLICATE);
        /* Log a Matchpoint entry. */
        entry = new SingleItemEntry(LogEntryType.LOG_MATCHPOINT, 
                                    new Matchpoint(1));
        envImpl.getLogManager().log(entry, ReplicationContext.NO_REPLICATE);
        ...
        TestUtilLogReader reader = new TestUtilLogReader
            (DbInternal.getEnvironmentImpl(env2), true /* readFullItem */);
