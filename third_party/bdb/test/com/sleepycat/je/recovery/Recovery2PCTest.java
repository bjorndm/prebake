 ...
 *
 * $Id: Recovery2PCTest.java,v 1.24 2010/01/04 15:51:03 cwl Exp $
 */
...
public class Recovery2PCTest extends RecoveryTestBase {
    ...
    public void testDetectUnfinishedXATxns()
        throws Throwable {

        createXAEnvAndDbs(1 << 20, false/*runCheckpointerDaemon*/, 1, true);
