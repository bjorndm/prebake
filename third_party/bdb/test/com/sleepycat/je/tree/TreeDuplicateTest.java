 ...
 *
 * $Id: TreeDuplicateTest.java,v 1.56 2010/01/04 15:51:07 cwl Exp $
 */
...
public class TreeDuplicateTest extends TreeTestBase {
    ...
    public void testGetFirstLast()
        ...
        try {
            ...
            fail("Tree.getFirstNode didn't throw EnvironmentFailureException");
        ...
        try {
            ...
            fail("Tree.getLastNode didn't throw EnvironmentFailureException");
        } catch (EnvironmentFailureException expected) {
        }
        TestUtils.checkLatchCount();
