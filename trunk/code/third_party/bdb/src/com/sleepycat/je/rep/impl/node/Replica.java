 ...
 *
 * $Id: Replica.java,v 1.83 2010/01/04 15:50:47 cwl Exp $
 */
...
public class Replica {
     ...
     * socket is configured with a read timeout that's multiple of the
    ...
    private void createReplicaFeederChannel()
        ...
        replicaFeederChannel = new NamedChannel(channel);
        ...
        long readTimeout = ((long)configManager.
            getInt(RepParams.FEEDER_HEARTBEAT_TIMEOUT)) *
            repNode.getHeartbeatInterval();
        socket.setSoTimeout(readTimeout > Integer.MAX_VALUE ?
                            0 : ((int) readTimeout));
