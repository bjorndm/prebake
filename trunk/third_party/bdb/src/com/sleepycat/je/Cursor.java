 ...
 *
 * $Id: Cursor.java,v 1.254 2010/01/04 15:50:36 cwl Exp $
 */
...
public class Cursor {
    ...
    int countInternal(final LockMode lockMode) {
        try {
             ...
             */
            final CursorImpl dup = cursorImpl.cloneCursor(true);
            try {
    ...
    OperationStatus deleteNoNotify(final ReplicationContext repContext) {
         ...
         */
        try {
            /* Evict before/after operation when not cloning the cursor. */
    ...
    private CursorImpl beginMoveCursor(final boolean addCursor,
        ...
        CursorImpl dup = cursorImpl.cloneCursor(addCursor, usePosition);
