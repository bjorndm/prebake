 ...
 *
 * $Id: EnvironmentConfig.java,v 1.84 2010/01/06 04:23:23 linda Exp $
 */
...
public class EnvironmentConfig extends EnvironmentMutableConfig {
     ...
     *
     * @param timeout The lock timeout.  A value of 0 disables lock timeouts,
     * meaning that no lock wait time limit is enforced.
     *
