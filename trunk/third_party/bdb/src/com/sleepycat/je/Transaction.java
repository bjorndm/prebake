 ...
 *
 * $Id: Transaction.java,v 1.83 2010/01/04 15:50:36 cwl Exp $
 */
...
public class Transaction {
     ...
     * application.</p>
     *
     * @param timeOut The lock request timeout value for the transaction.  A
     * value of 0 disables lock timeouts for the transaction, meaning that no
     * limit on the time to wait for a lock is enforced.
     *
     * @param unit the {@code TimeUnit} of the timeOut value. May be null only
     * if timeOut is zero.
     *
