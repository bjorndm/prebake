 ...
 *
 * $Id: FileManager.java,v 1.226 2010/01/04 15:50:43 cwl Exp $
 */
...
public class FileManager {
     ...
     */
    StatGroup stats;
    LongStat nRandomReads;
    LongStat nRandomWrites;
    LongStat nSequentialReads;
    LongStat nSequentialWrites;
    LongStat nRandomReadBytes;
    LongStat nRandomWriteBytes;
    LongStat nSequentialReadBytes;
    LongStat nSequentialWriteBytes;
    IntStat nFileOpens;
    IntStat nOpenFiles;
    LongStat nBytesReadFromWriteQueue;
    LongStat nBytesWrittenFromWriteQueue;
    LongStat nReadsFromWriteQueue;
    LongStat nWritesFromWriteQueue;
    LongStat nWriteQueueOverflow;
