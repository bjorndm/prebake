 ...
 *
 * $Id: Feeder.java,v 1.72 2010/01/04 15:50:47 cwl Exp $
 */
...
final public class Feeder {
     ...
     * @throws IOException
     */
    SocketChannel configureChannel(SocketChannel channel)
        throws IOException {
        ...
        try {
            ...
            long readTimeout = ((long)repNode.getConfigManager().
                getInt(RepParams.FEEDER_HEARTBEAT_TIMEOUT)) *
                repNode.getHeartbeatInterval();

            channel.socket().setSoTimeout(readTimeout > Integer.MAX_VALUE ?
                                          0 /* wait indefinitely */ :
                                          ((int) readTimeout));
    ...
    Feeder(FeederManager feederManager, SocketChannel feederReplicaChannel)
        ...
        this.feederReplicaChannel =
            new NamedChannel(configureChannel(feederReplicaChannel));
