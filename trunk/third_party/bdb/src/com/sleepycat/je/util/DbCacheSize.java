 ...
 *
 * $Id: DbCacheSize.java,v 1.26 2010/01/04 15:50:52 cwl Exp $
 */
...
public class DbCacheSize {
    ...
    private void caclulateCacheSizes() {
        final int nodeAvg = (nodeMax * density) / 100;
        final long nBinEntries = (records * nodeMax) / nodeAvg;
        final long nBinNodes = (nBinEntries + nodeMax - 1) / nodeMax;
