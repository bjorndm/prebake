 ...
 *
 * $Id: RecoveryTestBase.java,v 1.132 2010/01/04 15:51:03 cwl Exp $
 */
...
public class RecoveryTestBase extends TestCase {
     ...
     */
    protected List<RecoveryInfo> recoverAndVerify(Map<TestData,
    ...
    private List<RecoveryInfo>
        ...
        List<RecoveryInfo> infoList =
            recoverOnlyInternal(numDbs, createXAEnv, readOnlyMode);
    ...
    private List<RecoveryInfo> recoverOnlyInternal(int numDbs,
        ...
        infoList.add
            (DbInternal.getEnvironmentImpl(env).getLastRecoveryInfo());
