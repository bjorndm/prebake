 ...
 *
 * $Id: SecondaryTest.java,v 1.59 2010/01/04 15:51:07 cwl Exp $
 */
...
public class SecondaryTest extends MultiKeyTxnTestCase {
    ...
    static protected Class<?> testClass = SecondaryTest.class;

    public static Test suite() {
        return multiKeyTxnTestSuite(testClass, envConfig, null);
    }
    ...
    private void assertPriLocked(final Database priDb,
        ...
        junitThread = new JUnitThread("primary-locker") {
            ...
            public void testBody() {
                Cursor cursor = priDb.openCursor(null, null);
                try {
                    if (data != null) {
                    ...
                    assertTrue(expected instanceof LockConflictException);
                } finally {
                    cursor.close();
                }
            }
